...
export default function Payroll() {
  return (
    <div>
        ...
        <section>
  <img src={Calculate} alt="" className="w-full h-auto px-15" />
</section>
...
<div className="mx-4 sm:mx-10 lg:mx-20 my-10 flex flex-col lg:flex-row justify-between gap-10">
  ...
  <div className="text-center lg:text-left w-full lg:w-1/2" data-aos="fade-right">
    ...
    <button
      className="text-white font-bold py-4 px-6 mt-6 rounded-md bg-gradient-to-b from-[#1445C2] to-[#587EDB] hover:from-[#587EDB] hover:to-[#1445C2] transition"
      data-aos="fade-up"
      data-aos-delay="700"
    >
