  ...
  return (
    <div className='overflow-hidden' >
      ...
      <div className="text-center my-10" data-aos="fade-up">
        <h1 className="sm:text-[60px] text-5xl lg:text-[95px] tracking-tighter font-semibold">
          <span className="bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent tracking-[-0.06em]">
            Book
          </span>{' '}
          keeping
        </h1>
        <p className="mt-3 lg:mx-65">
          An organized bookkeeping service is like a cornerstone of any business. With our meticulous bookkeeping service, be rest assured that all your financial records are up-to-date.
        </p>
      </div>
