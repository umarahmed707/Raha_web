...
export default function BussinessCardsection() {
  return (
    <div><div className="mx-4 sm:mx-10 lg:mx-20  flex flex-col lg:flex-row justify-between gap-10">
     
      <div className="text-center lg:text-left w-full lg:w-50%" data-aos="fade-right">
      ...
      <div className="flex flex-col w-full lg:w-50% gap-6 mb-5 lg:mt-0">
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <div className="w-full sm:w-1/2 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Estimate potential income from sales and other sources."
            />
          </div>
          <div className="w-full sm:w-1/2 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Identify and allocate funds for operational costs."
            />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <div className="w-full sm:w-1/2 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Predict cash inflows and outflows to avoid shortages."
            />
          </div>
          <div className="w-full sm:w-1/2 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Set clear financial objectives to measure success."
            />
          </div>
        </div>
      </div>
