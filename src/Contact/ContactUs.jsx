...
export default function ContactUs() {
  ...
  {/* Button */}
  <div>
    <button  onClick={() => window.location.href = 'tel:+16282004141'} className="text-white w-full font-bold py-4 px-6 rounded-md bg-gradient-to-b from-[#1445C2] to-[#587EDB] border hover:border hover:bg-none hover:text-[#1445C2] transition-all duration-300">
      Get Call Back
    </button>
  </div>
</div>
    ...
    {/* Right Map Section */}
    <div className="w-full sm:w-[550px] h-[00px] sm:h-[500px] md:h-[550px] rounded-lg overflow-hidden shadow-lg mt-10 mb-10">
  <iframe
    title="Google Map"
