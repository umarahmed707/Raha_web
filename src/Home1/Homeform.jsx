...
export default function Homeform() {
  ...
  return (
    <div>
      <div className="mx-4 sm:mx-20 my-10 flex flex-col lg:flex-row justify-center items-center ">
        ...
        <div className="w-full max-w-2xl mx-auto p-6" data-aos="fade-left">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <button type="submit" className=" sm:text-2xl text-white shadow-lg bg-gradient-to-b from-[#1445C2] to-[#587EDB]  hover:border hover:bg-none border hover:text-[#1445C2] py-3  px-5 rounded-lg transition duration-300">
                Submit Now
              </button>
            </div>
          </form>
