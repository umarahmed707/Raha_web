...
export default function Construction() {
  ...
  return (
    ...
    <div className='text-center mb-5 lg:my-10'>
            <h1 className='sm:text-[60px] text-5xl lg:text-[70px] tracking-tighter font-semibold '>Construction and <span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[70px]  tracking-[-0.06em]'>Infrastructure</span></h1>
...
<h2 className="text-3xl mt-5 font-bold text-gray-800 mb-6">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Residential Construction</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Commercial Construction</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Infrastructure Development</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Engineering Services</h3>
      <p className="text-lg text-gray-700 mb-6">
