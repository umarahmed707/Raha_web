  ...
  return (
    <div className='lg:mx-25 p-8 '> 
                  <div className='text-center mb-5 lg:my-10'>
                          <h1 className='sm:text-[60px] text-5xl lg:text-[70px] tracking-tighter font-bold '>Real<span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[70px]  tracking-[-0.06em]'> Estate</span></h1>
      ...
      <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Residential Real Estate</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Commercial Real Estate</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Property Development</h3>
      <p className="text-lg text-gray-700 mb-6">
      ...
      <h3 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Real Estate Investment Trusts (REITs)</h3>
      <p className="text-lg text-gray-700 mb-6">
