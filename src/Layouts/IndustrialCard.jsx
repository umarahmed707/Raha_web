...
export default function IndustrialCard(props) {
  return (
    <div>
        <div className='p-5 rounded-2xl bg-gradient-to-b from-[#f5efef] to-[#ffffff] hover:from-[#ffffff] hover:to-[#b3c1e0] hover:border-[#1445C2] border border-gray-300 w-90 md:w-95 h-65'>
