...
import ConsultantModel from '../Modelfile/ConsultantModel';
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row flex-wrap justify-center gap-6" data-aos="fade-up">
        ...
        <div className="Spot group w-full sm:w-[350px]" data-aos="zoom-in">
          <div className="SpotCard p-6 bg-opacity-80 rounded-lg">
            <div className="bg-white w-[70px] h-[65px] group-hover:bg-[#1445C2] rounded-2xl p-3 flex justify-center">
              <img src={img1} alt="Personal Plan" width={35} />
            </div>
            ...
            <button
              className="mt-26 text-[#1445C2] font-bold py-3 w-full rounded-md bg-gradient-to-b from-white to-gray-300 group-hover:from-[#1445C2] group-hover:to-[#587EDB] group-hover:text-white"
            onClick={() => openModal(0)}>Learn More</button>
          </div>
        </div>

        {/* Plan 2 */}
        <div className="Spot group w-full sm:w-[350px]" data-aos="zoom-in" data-aos-delay="100">
          <div className="SpotCard p-6 bg-opacity-80 rounded-lg">
            <div className="bg-white w-[70px] h-[65px] group-hover:bg-[#1445C2] rounded-2xl p-3 flex justify-center">
              <img src={img2} alt="Standard Plan" width={35} />
            </div>
            ...
            <ul className="text-sm space-y-2 mt-3 opacity-90">
              {['Bookkeeping', 'Accounts receivable', 'Accounts payable', 'Monthly financials'].map(
                (item, idx) => (
                  <li key={idx} className="flex gap-2 items-center">
                    <FaCheck size={15} className="text-white group-hover:text-[#1445C2]" />
                    {item}
               ...
               <button
              className="mt-33 text-[#1445C2] font-bold py-3 w-full rounded-md bg-gradient-to-b from-white to-gray-300 group-hover:from-[#1445C2] group-hover:to-[#587EDB] group-hover:text-white"
              onClick={() => openModal(0)}
            >
              Learn more
            </button>
        ...
        {/* Plan 3 */}
        <div className="Spot group w-full sm:w-[350px]" data-aos="zoom-in" data-aos-delay="200">
          <div className="SpotCard p-6 bg-opacity-80 rounded-lg">
            <div className="bg-white w-[70px] h-[65px] group-hover:bg-[#1445C2] rounded-2xl p-3 flex justify-center">
              <img src={img3} alt="Advanced Plan" width={35} />
            </div>
            ...
            <ul className="text-sm space-y-2 mt-3 opacity-90">
             ...
             <button
              className="mt-5 text-[#1445C2]  font-bold py-3 w-full rounded-md bg-gradient-to-b from-white to-gray-300 group-hover:from-[#1445C2] group-hover:to-[#587EDB] group-hover:text-white"
             onClick={() => openModal(0)}
            >
              Learn more
            </button>
        ...
        >
          <div className="SpotCard p-6 md:p-8 bg-opacity-80 rounded-lg max-w-6xl mx-auto">
            ...
            <div className="pt-5">
              <button
                className="px-6 py-3 bg-gradient-to-b from-[#ffffff] to-[#DADADA] group-hover:from-[#1445C2] group-hover:to-[#7a99e9] group-hover:text-white text-[#1445C2] rounded-lg font-bold"
      ...
      <ConsultantModel isOpen={showConsultantModal} onClose={() => setShowConsultantModal(false)} />
...
<div>
    ...
    />
      ...
      <button
          type="submit"
          className="Next-button border mt-5 text-[#1445C2] px-4 py-2 text-[16px] sm:text-[18px] md:text-[20px] rounded-lg bg-gradient-to-b from-[#ffffff] to-[#DADADA] hover:from-[#1445C2] hover:text-white hover:to-[#587EDB] w-auto sm:w-auto md:w-auto lg:w-auto"
    ...
    <div className="flex flex-col md:flex-row">
      <div className="client w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-6">
          ...
          <div className="modal flex justify-center lg:justify-center gap-25 lg:gap-100">
