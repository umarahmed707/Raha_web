...
export default function Header() {
  ...
  return (
    ...
    <div>
  <div>
      <div className="flex flex-col justify-center items-center text-center my-25" data-aos="fade-up" data-aos-duration="1000">
  <h1 
  ...
  <p 
    className="mt-5 text-[12px] lg:text-[18px] mx-5 lg:mx-70" 
    data-aos="fade-up" 
    data-aos-delay="600"
  >
