...
import AuditCardsection from './AuditCardsection';

import Auditmid from './Auditmid';
...
export default function Software() {
  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className='text-center md:mt-15 mt-10 ' data-aos="fade-up" >
        <h1 className='sm:text-[60px] text-5xl lg:text-[85px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[85px]  tracking-[-0.06em]'>Audit and </span> Assurance</h1>
        <p className='mt-3 lg:mx-65 mx-5'>With increased demands for greater transparency, we provide high-quality audit and assurance services that meet the highest professional standards.
        </p>
      </div>
