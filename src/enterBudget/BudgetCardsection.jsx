...
export default function SoftwareCardsection() {
  return (
    <div><div className="mx-4 sm:mx-10 lg:mx-20 mt-5 flex flex-col lg:flex-row justify-between gap-10">

      <div className="text-start mx-5 lg:text-left w-full lg:w-1/2" data-aos="fade-right">
