...
import BussinessCardsection from './EnterBussinessCardsection';

import Bussiessmid from './EnterBussinessmid';
  ...
  return (
    <div className='overflow-hidden'>
       <div className='text-center mt-10' data-aos="fade-up">
                  <h1 className='sm:text-[60px] text-5xl lg:text-[85px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[85px]  tracking-[-0.06em]'>Business Payment</span> Collection</h1>
                  <p className='mt-3 lg:mx-65 mx-5'>Reduce the payment collection time ensuring a steady cashflow with Raha Financials
                  </p>
              </div>
    ...
    <div className="flex justify-center mt-10 z-15">
        <button
