  ...
  return (
    <div className='overflow-hidden'>
       <div className='text-center mt-10' data-aos="fade-up">
                  <h1 className='sm:text-[50px] mx-10 text-4xl lg:text-[70px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[50px] lg:text-[70px]  tracking-[-0.06em]'>Company</span> Restructuring Service</h1>
                  <p className='mt-3 lg:mx-65 mx-5'>Company restructuring involves reorganizing a business’s operations, structure, or financial obligations to make it profitable.
                  </p>
              </div>
