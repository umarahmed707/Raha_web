...
import HrCardsection from './HrCardsection';

import Hrmid from './Hrmid';
    ...
    <div className='overflow-hidden'>
      <div>
       <div className='text-center mt-10' data-aos="fade-up">
                  <h1 className='sm:text-[60px] text-5xl lg:text-[70px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[70px]  tracking-[-0.06em]'>HR Management and</span> Outsourcing</h1>
                  <p className='mt-3 lg:mx-65'>Our HR practices at Raha Financials offer increased productivity and efficiency.
                  </p>
              </div>
