...
export default function Softwaremid() {
  return (
    <div>
               <div className="w-full h-auto lg:mt-15 px-4 md:px-20 py-10 bg-cover bg-center rounded-lg~" data-aos="zoom-in"
          style={{
      ...
      >
          <div className="text-white text-center" data-aos="zoom-in">
            <h1 className="font-bold text-[32px] md:text-[60px] lg:mx-45 leading-15 tracking-[-0.06em]">Our Process</h1>
            <p className="mt-4 text-sm md:text-lg">
            Our HR services help businesses focus on their core competencies and strategic goals.
            </p>
          </div>
      ...
      <div className="SpotCard w-87 h-auto p-4">
        ...
        <h2 className="text-xl font-bold my-1" >Needs Assessment</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We help in the identification of your HR requirements and setting a budget.
        </p>
      </div>
      </div>
      ...
      <div className="SpotCard w-87 h-auto p-4">
        ...
        <h2 className="text-xl font-bold my-1" >Implementation</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We make a contract and Implement the HR practices to ensure a smooth transition.
        </p>
      </div>
      </div>
      <div className='Spot' data-aos="zoom-in">
      <div className="SpotCard w-87 h-auto p-4">
        ...
        <h2 className="text-xl font-bold my-1" >HR Management</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We carefully tackle any issues coming along the way and help you achieve your goals.
        </p>
      </div>
      </div>
      
          </div>
          <div className="flex w-full flex-row justify-center mt-15 sm:justify-center gap-3 sm:gap-4 pb-5" data-aos="zoom-in">
        ...
        <div className='text-center mt-15' data-aos="zoom-in">
             ...
             <Link to="/Consultationform">
                                  <button className="rounded-lg border py-2 px-2 mt-5 sm:py-4 sm:px-6 text-xs sm:text-[18px] text-white bg-gradient-to-b from-[#1445C2] to-[#587EDB] hover:from-[#ffffff] hover:to-[#DADADA] hover:text-[#1445C2] hover:border w-auto sm:w-auto " data-aos="fade-up"
                       data-aos-delay="700">
                                    Request Consultation
                                  </button>
                                  </Link>
