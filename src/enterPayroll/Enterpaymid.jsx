    ...
    <div>
      ...
      >
        <div className="text-white text-center" data-aos="zoom-in">
          <h1 className="font-bold text-[32px] md:text-[60px] lg:mx-45 leading-9 lg:leading-15 tracking-[-0.06em]">Our Payroll advisory process</h1>
          <p className="mt-4 text-sm md:text-lg">
            We provide expert payroll advisory services to optimize your payroll operations.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 mt-12">
          ...
          <div className='Spot' data-aos="zoom-in">
            <div className="SpotCard w-87 h-auto p-4">
              ...
              <h2 className="text-xl font-bold my-1" >Payroll System Evaluation</h2>
              <p className="text-[16px] space-y-1 opacity-90">
                Assessing the capabilities, limitations, and integration of the payroll system
              </p>
            </div>
          </div>
          ...
          <div className='Spot' data-aos="zoom-in">
            <div className="SpotCard w-87 h-auto p-4">
              ...
              <h2 className="text-xl font-bold my-1" >Compliance Review</h2>
              <p className="text-[16px] space-y-1 opacity-90">
                Inspecting payroll policies, procedures, and documentation for accuracy
              </p>
            </div>
          </div>
          <div className='Spot' data-aos="zoom-in">
            <div className="SpotCard w-87 h-auto p-4">
              ...
              <h2 className="text-xl font-bold my-1" >Payroll Optimization</h2>
              <p className="text-[16px] space-y-1 opacity-90">
                We are ensuring that the payroll system is up-to-date with tax regulations.
              </p>
            </div>
          </div>
