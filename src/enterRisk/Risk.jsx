...
import RiskCardsection from './RiskCardsection';

import Riskmid from './Riskmid';
  ...
  return (
    <div className='overflow-hidden'>
       <div className='text-center mt-10' data-aos="fade-up">
                  <h1 className='sm:text-[60px] text-5xl lg:text-[85px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[85px]  tracking-[-0.06em]'>Risk</span> Advisory</h1>
                  <p className='mt-3 lg:mx-65'>Risk Advisory is the process of estimating future income and expenses.
                  </p>
              </div>
