...
import FinancialCardsection from './FinancialCardsection';
import Financialmid from './Financialmid';
  ...
  return (
    <div className='overflow-hidden'>
       <div className='text-center mt-10 ' data-aos="fade-up">
                  <h1 className='sm:text-[50px] lg:mx-35 text-4xl lg:text-[70px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[50px] lg:text-[70px]  tracking-[-0.06em]'>Financial Management</span> and Consulting Services</h1>
                  <p className='mt-3'>Say No to management stress with our expert guidance and support by Raha Financials.
                  </p>
              </div>
