    ...
    <div>
      ...
      >
          <div className="text-white text-center" data-aos='zoom-in'>
            <h1 className="font-bold text-[32px] md:text-[60px] tracking-[-0.06em]">Our approach involves:</h1>
            <p className="mt-4 text-sm md:text-lg">
            Make informed decisions and mitigate risks with Raha Financials.
            </p>
          </div>
      ...
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        After thorough research, we start by gathering financial data, including income statements, balance sheets, and cash flow statements.
        </p>
      </div>
      </div>
      ...
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        <h2 className="text-lg font-bold my-1">Financial analysis</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We move with collected data and start analysis using advanced tools to identify trends, and evaluate performance.
        </p>
      </div>
      </div>
      <div className='Spot' data-aos='zoom-in'>
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        <h2 className="text-lg font-bold my-1">Development support</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We offer support in developing and implementing new strategies and techniques recommended.
        </p>
      </div>
      </div>
    ...
    className="border text-[#1445C2] text-xs sm:text-[18px] rounded-lg py-1 sm:py-4 sm:px-4 bg-gradient-to-b from-[#ffffff] to-[#DADADA] hover:from-[#587EDB] hover:to-[#1445C2] hover:text-white w-[30%] sm:w-[10%]">
      Call Us
        ...
        <div className='text-center mt-10' data-aos='zoom-in'>
                  ...
                  <p className='mt-3'>Calculating and distributing salaries and wages to employees, withholding and paying payroll taxes.
                  </p>
              <Link to="/Consultationform">
    <button className="rounded-lg py-2 px-2 sm:py-4 mt-10 sm:px-6 text-xs sm:text-[18px] text-white bg-gradient-to-b from-[#1445C2] to-[#587EDB] hover:from-[#ffffff] hover:to-[#DADADA] hover:text-[#1445C2] hover:border w-auto sm:w-auto">
      Request Consultation
    </button>
    </Link>
              </div>
