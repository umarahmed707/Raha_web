...
import SoftwareCardsection from './SoftwareCardsection';
import { Link } from 'react-router-dom';
import Softwaremid from './Softwaremid';
import AOS from 'aos';
  ...
  return (
    <div className='overflow-hidden'>
      <div className='text-center my-10' data-aos="fade-up">
        <h1 className='sm:text-[60px] text-5xl lg:text-[85px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[85px]  tracking-[-0.06em]'>Software Setup</span> & Integration</h1>
        <p className='mt-3 lg:mx-65 mx-5'>At RAHA Financials, our expert team offers a wide software selection and setup services such as Xero and Quickbooks, and helps your business by recommending the best solution for your business.
        </p> 
      </div>
