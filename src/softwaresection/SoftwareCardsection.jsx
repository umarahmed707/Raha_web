    ...
    <div><div className="mx-4 sm:mx-10 lg:mx-20  flex flex-col lg:flex-row justify-between gap-10">
      ...
      <div className="text-center lg:text-left w-full lg:w-1/2" data-aos="fade-right">
        <h1 className="text-[32px] sm:text-[48px] lg:text-[55px] font-bold tracking-[-0.06em] leading-tight">
          Why do you need
          <span className="text-3xl sm:text-[40px] lg:text-[50px] font-bold tracking-[-0.06em] bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent">
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <div className="w-full sm:w-1/1 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="recommend suitable accounting software options, such as Xero or QuickBooks. Our expert team offers complete support in installation."
            />
          </div>
          <div className="w-full sm:w-1/1 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Our expert technical team offers complete support in the customization of selected software according to your business needs."
            />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <div className="w-full sm:w-1/1 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="Our expert team offers complete support in setting up your financial software, whether it is Xero, Quickbooks, or any other suitable software."
            />
          </div>
          <div className="w-full sm:w-1/1 flex justify-center" data-aos="fade-up">
            <CardLayouts
              ...
              parah="With our expertise in software selection and support, we provide complete training to you ensuring that you get the most out of your investment and minimize any technical problem."
            />
          </div>
        </div>
      </div>
