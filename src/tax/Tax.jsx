  ...
  return (
    <div className='overflow-hidden'>
       <div className='text-center my-10' data-aos="fade-up">
                  <h1 className='sm:text-[60px] text-5xl lg:text-[95px] tracking-tighter font-semibold '><span className='bg-gradient-to-b from-[#1445C2] to-[#587EDB] bg-clip-text text-transparent mt-0 sm:text-[60px] lg:text-[95px]  tracking-[-0.06em]'>Tax Filing</span>  Services</h1>
                  <p className='mt-3'>To overcome the complex tax filing process, RAHA Financials offers an accurate tax filing service.
                  </p>
              </div>
