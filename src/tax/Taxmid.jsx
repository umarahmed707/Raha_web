...
export default function Taxmid() {
      useEffect(() => {
    ...
    <div>
      ...
      >
          <div className="text-white text-center" data-aos="zoom-in">
            ...
            We provide comprehensive tax filing services, ensuring accuracy and timely submission.
            </p>
          </div>
      ...
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        <h2 className="text-xl font-bold my-1" >Gather Client Information</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        Obtaining clients' personal and business information, and financial documents and verifying accuracy.
        </p>
      </div>
      </div>
      ...
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        <h2 className="text-lg font-bold my-1">Prepare Tax Returns</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        Selection of correct tax forms based on your business structures and accurately calculating your clients' taxable income.
        </p>
      </div>
      </div>
      <div className='Spot' data-aos="zoom-in">
      <div className="SpotCard w-87 lg:w-90 h-auto p-4">
        ...
        <h2 className="text-lg font-bold my-1">File Tax Returns</h2>
        <p className="text-[16px] space-y-1 opacity-90">
        We offer electronic filing to expedite the process of making tax payments File Tax Returns.
        </p>
      </div>
      </div>
